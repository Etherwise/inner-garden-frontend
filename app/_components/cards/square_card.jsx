  ...
  return (
    <div className={`relative w-fit h-fit ${className.main}`}>
      ...
      <Image src={cardImage ? cardImage : womanImage} alt='womanImage' className={`h-[40%] w-[100%] object-cover ${className.image}`}/>
        <p className={`bg-white w-full min-h-[60%] h-fit px-8 py-6 font-bold text-lg text-left text-purple-inner-octagon ${className.text}`}>Around the world, a new awareness is blooming — that our emotions, like our bodies, are a part of nature, and that we can cultivate them like a garden. Around the world, a new </p>
      </section>
          {children}
    </div>
