  ...
  return (
    <>
      <Banner className="mt-6 aspect-[2.3/1] md:aspect-[2.9/1] w-full" shape="rect" angle={angle} innerangle={15}>
        ...
        className="absolute top-0 left-[calc(50%-40%)] md:left-[calc(50%-35%)] lg:left-[calc(50%-30%)] w-[80%] md:w-[70%] lg:w-[60%] text-xl smd:text-2xl lg:text-3xl text-center">
          <LabelComponent className="absolute left-1/2 translate-x-[-50%] w-max z-10" text={["aware", "nest"]} align={{do: true, value: 0}} />
