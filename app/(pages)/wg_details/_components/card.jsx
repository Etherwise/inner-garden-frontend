...
const Card = () => {
  ...
  return (
    <SquareCard className = {{main : "!w-[24%]" , image : "" , text : "text-[18px] leading-5 !text-black"}}>
            <LabelComponent angle={14} text={["compassion","title"]} align={"top"} shape='hexagon' className='w-[63%] h-[14%] left-[50%] translate-x-[-50%]' textClasses={"text-lg"} bracketClassName=' text-lg !w-[70%]'/>
                <section ref={cardBottomSectionRef} className='h-fit absolute left-[50%] translate-x-[-50%] w-[90%] flex items-center justify-between'>
                  ...
                  <p className='bg-[#4F81E5] px-[16px] flex items-center justify-center aspect-square text-white font-bold' ref={pointsOctaRef}>20</p>
                  </div>
                </section>
          </SquareCard>
  )
